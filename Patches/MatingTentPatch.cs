...
namespace MatingTentMod.Patches
{
    ...
    internal class MatingTentPatch
    {
        ...
        {
            PlacementTile closestTileAtWorldPosition = __instance.GetClosestTileAtWorldPosition(__instance.PlacementPosition);
            if (closestTileAtWorldPosition == null)
            {
                return;
            }
            PlacementRegion.TileGridTile tileGridTile = __instance.GetTileGridTile(closestTileAtWorldPosition.GridPosition.x, closestTileAtWorldPosition.GridPosition.y);
